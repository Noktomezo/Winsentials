  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          'pointer-events-none block rounded-[calc(var(--radius-sm)-2px)] bg-white ring-0 transition-[transform,background-color] group-data-[size=default]/switch:size-[14px] group-data-[size=sm]/switch:size-[10px] data-[state=checked]:translate-x-full data-[state=unchecked]:translate-x-0 dark:bg-[#0f1726]',
        )}
      />
    </SwitchPrimitive.Root>
  )
