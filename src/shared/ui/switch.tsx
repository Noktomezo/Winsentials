  ...
  return (
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          'pointer-events-none block rounded-[calc(var(--radius-sm)-2px)] bg-white ring-0 transition-all duration-200 ease-[cubic-bezier(0.16,1,0.3,1)] group-data-[size=default]/switch:size-[14px] group-data-[size=sm]/switch:size-[10px] data-[state=checked]:translate-x-full data-[state=unchecked]:translate-x-0 dark:bg-[#0f1726]',
        )}
      />
    </SwitchPrimitive.Root>
  )
