...
use crate::entities::tweaks::{RestartRequirement, TweakCategory, TweakDefinition, get_all_tweaks};
...
impl RenderOnce for ContextMenuPage {
    fn render(self, window: &mut Window, cx: &mut App) -> impl IntoElement {
        ...
        let route = AppRoute::ContextMenu;
        ...
        for tweak in all_tweaks {
            if tweak.category == TweakCategory::ContextMenu && tweak.is_supported(windows_build) {
