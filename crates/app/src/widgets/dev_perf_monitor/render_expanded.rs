...
use gpui::{
    InteractiveElement, IntoElement, MouseButton, ParentElement, Pixels, Point, Rgba,
        ...
        .child(
            div()
                ...
                .child({
                    ...
                    let close_spring = hover_spring(if is_close_hovered { 0.6 } else { 0.0 });
                    ...
                    div()
                        ...
                        .child(
                            div()
                                ...
                                .child(
                                    div()
                                        .text_color(if snapshot.displayed_drop_rate > 0.0 {
                                            theme.accent_red
                                        } else {
                                            theme.accent_green
                                        })
                                        .child(format!("{:.1}%", snapshot.displayed_drop_rate)),
                                ),
                        )
                        .child(
                            div()
                                ...
                                .child(
                                    div()
                                        .text_color(theme.text_primary)
                                        .child(format!("{:.1}ms", snapshot.cpu_draw_ms)),
                                ),
                        )
                        .child(
                            div()
