    ...
    div()
        ...
        .child(
            div()
                ...
                .child({
                    let is_tel_hovered = snapshot.hovered_control == Some("telemetry");
                    let tel_spring = hover_spring(if is_tel_hovered { 0.5 } else { 0.0 });
        ...
        .child(
            div()
                ...
                .child({
                    let is_chart_hovered = snapshot.hovered_control == Some("chart_anim");
                    let chart_spring = hover_spring(if is_chart_hovered { 0.5 } else { 0.0 });
        ...
        .child(
            div()
                ...
                .child({
                    let is_cont_hovered = snapshot.hovered_control == Some("continuous");
                    let cont_spring = hover_spring(if is_cont_hovered { 0.5 } else { 0.0 });
