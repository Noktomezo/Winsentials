...
impl RenderOnce for ExplorerPage {
    fn render(self, window: &mut Window, cx: &mut App) -> impl IntoElement {
        let theme = Theme::get(cx);
        let route = AppRoute::Explorer;
        ...
        for tweak in all_tweaks {
            if tweak.category == TweakCategory::Explorer && tweak.is_supported(windows_build) {
