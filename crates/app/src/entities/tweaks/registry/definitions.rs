...
pub const ALL_TWEAKS: &[TweakDefinition] = &[
    ...
    TweakDefinition {
        id: "disable_password_expiration",
        category: TweakCategory::System,
        icon: "icons/key-round.svg",
        title_key: "tweaks.disable_password_expiration_title",
        desc_key: "tweaks.disable_password_expiration_desc",
        min_build: None,
        max_build: None,
        custom_support: None,
        restart: RestartRequirement::None,
